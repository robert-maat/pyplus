...
def conDevFunc(device):
    ...
    output = conDev.send_command_timing("ping", strip_prompt=False, strip_command=True) + "\n"
    output += conDev.send_command_timing("\n", strip_prompt=False, strip_command=True) + "\n"
    output += conDev.send_command_timing("8.8.8.8", strip_prompt=False, strip_command=True) + "\n"
    output += conDev.send_command_timing("\n", strip_prompt=False, strip_command=True) + "\n"
    output += conDev.send_command_timing("\n", strip_prompt=False, strip_command=True) + "\n"
    output += conDev.send_command_timing("\n", strip_prompt=False, strip_command=True) + "\n"
    output += conDev.send_command_timing("\n", strip_prompt=False, strip_command=True) + "\n"
